  ...
  return (
    <div className="space-y-6">
      ...
      <section className="bg-gray-900 border border-gray-800 rounded-xl p-6">
        <h2 className="text-lg font-semibold text-gray-200 mb-1">Plex Connection</h2>
        <p className="mb-4 text-sm text-gray-400">Connect to your Plex server. Plex is read-only here.</p>
          ...
          {!settings.plexToken.lockedByEnvironment && (
            <label className="block">
              ...
              <div className="flex rounded-lg border border-gray-700 bg-gray-950 focus-within:border-purple-500">
                ...
                />
                <button type="button" onClick={() => setShowPlexToken((v) => !v)} className="rounded-r-lg px-3 text-xs font-semibold text-gray-400 hover:text-white">
