          ...
          {!settings.tvdbApiKey.lockedByEnvironment && (
            <label className="block">
              ...
              <div className="flex rounded-lg border border-gray-700 bg-gray-950 focus-within:border-purple-500">
                ...
                />
                <button type="button" onClick={() => setShowTvdbApiKey((v) => !v)} className="rounded-r-lg px-3 text-xs font-semibold text-gray-400 hover:text-white">
            ...
            <label className="block">
              ...
              <div className="flex rounded-lg border border-gray-700 bg-gray-950 focus-within:border-purple-500">
                <input
                  ...
                  className="min-w-0 flex-1 rounded-l-lg bg-transparent px-3 py-2 text-gray-100 outline-none"
                />
                <button type="button" onClick={() => setShowTvdbPin((v) => !v)} className="rounded-r-lg px-3 text-xs font-semibold text-gray-400 hover:text-white">
